      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="mt-4 text-lg text-text-secondary max-w-2xl mx-auto">
            End-to-end voice AI solutions — from design to deployment to
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            ...
            >
              <div className="w-14 h-14 rounded-xl bg-linear-to-br from-accent-blue to-accent-cyan flex items-center justify-center text-white mb-6 transition-transform duration-300 group-hover:scale-110">
                {service.icon}
              </div>
              <h3
